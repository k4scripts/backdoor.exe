...
-- Instances: 87 | Scripts: 0 | Modules: 0
local G2L = {};
setmetatable(G2L, {__metatable = "Hands of my table."})
...
G2L["41"]["Image"] = [[http://www.roblox.com/asset/?id=6026663699]];
G2L["41"]["Size"] = UDim2.new(0.18320611119270325, 0, 1, 0);
G2L["41"]["Position"] = UDim2.new(0.022900763899087906, 0, 0.5, 0);
...
G2L["43"] = Instance.new("ImageLabel", G2L["3e"]);
G2L["43"]["ZIndex"] = 2;
...
G2L["44"]["Image"] = [[http://www.roblox.com/asset/?id=6022668885]];
G2L["44"]["Size"] = UDim2.new(0.16030533611774445, 0, 1, 0);
...
G2L["46"] = Instance.new("ImageLabel", G2L["3e"]);
G2L["46"]["ZIndex"] = 2;
...
G2L["47"]["Image"] = [[http://www.roblox.com/asset/?id=6031075929]];
...
G2L["49"] = Instance.new("ImageLabel", G2L["3e"]);
G2L["49"]["ZIndex"] = 2;
